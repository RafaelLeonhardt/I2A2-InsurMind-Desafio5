...
export interface paths {
    ...
    "/api/v1/segurados/{segurado_id}/comunicados": {
        ...
        /**
         * Listar todos os comunicados do segurado ativo
         * @description Devolve todos os comunicados do segurado, mais antigos primeiro, com canal, assunto/resumo, data e a visualização já registrada, se houver. Lista vazia quando o segurado não tiver nenhum comunicado.
         */
        get: operations["listar_comunicados_api_v1_segurados__segurado_id__comunicados_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/segurados/detalhado": {
        ...
        /**
         * Listar os segurados sintéticos com dados detalhados para o admin
         * @description Devolve nome, área, apólice mais recente e canal preferencial de cada segurado do conjunto sintético semeado, ordenados por nome, para a superfície 'Segurados' do perfil Administrador auditar a base. Lista vazia quando os dados sintéticos ainda não foram restaurados; apólice nula quando o segurado não tiver nenhuma apólice.
         */
        get: operations["listar_segurados_detalhado_api_v1_segurados_detalhado_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * ProblemaListaComunicados
         * @description Falha da lista de comunicados, com ocorrência, impacto e próxima ação segura.
         */
        ProblemaListaComunicados: {
            /**
             * Codigo
        ...
        /**
         * RespostaItemComunicado
         * @description Um item da lista de comunicados: canal, assunto/resumo, data e visualização.
         */
        RespostaItemComunicado: {
            /**
             * Entrega Simulada Id
        ...
        /**
         * RespostaListaComunicados
         * @description A lista completa de comunicados do segurado.
         */
        RespostaListaComunicados: {
            /**
             * Comunicados
        ...
        /**
         * RespostaListaSeguradosDetalhado
         * @description A lista detalhada de todos os segurados sintéticos do seed.
         */
        RespostaListaSeguradosDetalhado: {
            /**
             * Segurados
             * @description Todos os segurados sintéticos do seed, com área, apólice mais recente e canal, ordenados por nome.
             */
            segurados: components["schemas"]["RespostaSeguradoDetalhado"][];
        };
        /**
         * RespostaLoteRevisao
         ...
         * @description Um segurado sintético com os dados básicos exibidos ao administrador.
         */
        RespostaSeguradoDetalhado: {
            /**
             * Id
            ...
            /**
             * Apolice Numero
             * @description Número da apólice mais recente do segurado, ou nulo se ele não tiver nenhuma apólice.
             */
...
export interface operations {
    ...
    listar_comunicados_api_v1_segurados__segurado_id__comunicados_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description Consulta realizada, com ou sem comunicados. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["RespostaListaComunicados"];
                };
            };
            /** @description O identificador do segurado não é um UUID válido. */
            422: {
    ...
    listar_segurados_detalhado_api_v1_segurados_detalhado_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RespostaListaSeguradosDetalhado"];
                };
            };
        };
    };
