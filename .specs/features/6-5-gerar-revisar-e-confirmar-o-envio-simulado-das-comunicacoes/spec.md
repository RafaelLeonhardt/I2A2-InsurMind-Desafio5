...
| --- | --- | --- | --- |
| FLUXOMSG-01 | P1: Acompanhar a preparação e a geração de mensagens | - | Pending |
| FLUXOMSG-02 | P1: Acompanhar a preparação e a geração de mensagens | - | Pending |
| FLUXOMSG-03 | P1: Acompanhar a preparação e a geração de mensagens | - | Pending |
| FLUXOMSG-04 | P1: Revisar a avaliação crítica de segurança de cada mensagem | - | Pending |
| FLUXOMSG-05 | P1: Revisar a avaliação crítica de segurança de cada mensagem | - | Pending |
| FLUXOMSG-06 | P1: Revisar o lote e confirmar o envio simulado | - | Pending |
| FLUXOMSG-07 | P1: Revisar o lote e confirmar o envio simulado | - | Pending |
| FLUXOMSG-08 | P1: Revisar o lote e confirmar o envio simulado | - | Pending |

**ID format:** `FLUXOMSG-NN`

**Status values:** Pending → In Design → In Tasks → Implementing → Verified

**Coverage:** 8 total, 0 mapped to tasks, 8 unmapped ⚠️ — fase Specify apenas; Design/Tasks pendentes.
