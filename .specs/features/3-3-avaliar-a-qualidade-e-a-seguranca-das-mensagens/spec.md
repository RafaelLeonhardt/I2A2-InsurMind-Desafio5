...
| CRIT-06 | P1: Transições de estado a partir da decisão do crítico | Design | Pending |
| CRIT-07 | P1: Transições de estado a partir da decisão do crítico | Design | Pending |
