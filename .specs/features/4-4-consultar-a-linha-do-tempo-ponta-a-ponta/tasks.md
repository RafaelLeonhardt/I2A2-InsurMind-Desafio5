...
- [x] `200` com a linha do tempo completa para execução existente
- [x] `404` para execução inexistente
- [x] Busca filtrada retorna só os resultados correspondentes; sem filtro retorna todas
