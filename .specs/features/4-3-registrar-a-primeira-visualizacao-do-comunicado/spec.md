...
| --- | --- | --- | --- |
| VISU-01 | P1: Primeira visualização registrada uma única vez | Execute (T1, T2, T5) | Implementing |
| VISU-02 | P1: Primeira visualização registrada uma única vez | Execute (T2, T5) | Implementing |
| VISU-03 | P1: Primeira visualização registrada uma única vez | Execute (T2) | Implementing |
| VISU-04 | P1: Recusa de estados não elegíveis e apresentação sem ação administrativa | Execute (T3, T4) | Implementing |
| VISU-05 | P1: Recusa de estados não elegíveis e apresentação sem ação administrativa | Execute (T3, T4) | Implementing |
| VISU-06 | P2: Falha local sem antecipação visual do estado | Execute (T5) | Implementing |
| VISU-07 | P2: Falha local sem antecipação visual do estado | Execute (T5) | Implementing |

**ID format:** `VISU-NN`

**Status values:** Pending → In Design → In Tasks → Implementing → Verified

**Coverage:** 7 total, 7 mapped to tasks (T1, T2, T3, T4, T5)
