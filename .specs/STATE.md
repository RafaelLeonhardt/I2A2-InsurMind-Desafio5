...
- **Next step**: Continuar o Épico 6 pela História 6.4 (Consultar segurados sintéticos) ou 6.7 (Monitorar a fonte meteorológica) — independentes entre si e dependem só de 6.1 (navegação já pronta). Depois: 6.5 → 6.6 (dependem de 6.2, já pronta), e por fim 6.8/6.9 (lado Segurado, independentes do restante do épico).
